...
public class ArticlesService implements IArticlesService {
    ...
    public PaginateArticlesResponse getPaginatedArticles(String type, int page, int pageSize) {
        ...
        if (type.equalsIgnoreCase("all")) {
            articlesPage = articlesRepository.findAllByOrderByDateDesc(pageable);
        } else {
            ArticlesType articlesType = ArticlesType.valueOf(type.toUpperCase());
            articlesPage = articlesRepository.findAllArticlesByType(articlesType, pageable);
        }
