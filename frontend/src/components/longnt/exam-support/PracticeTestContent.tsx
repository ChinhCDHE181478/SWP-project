  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <div className="mt-5 mb-5">
        ...
        Thi thử ở đầu trang hoặc từ mục Học viên trên Menu:
      </div>
      <div>
        <Image
      ...
      <div>
        <div>
          1 - Chọn <span className="font-bold">Đề thi</span> (ví dụ: Đề thi IOE
          Vòng 1, Vòng 2).
        </div>
        <div>
          2 - Nhấn <span className="font-bold">Bắt đầu thi</span> để vào bài
          thi.
        </div>
      </div>
    </div>
