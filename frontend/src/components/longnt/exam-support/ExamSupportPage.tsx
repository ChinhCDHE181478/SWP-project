...
import ExamAndOrganizationContent from "./ExamAndOrganizationContent";
import LearnWithEduContent from "./LearnWithEduContent";
...
const ExamSupportPage = () => {
  ...
  const renderContent = () => {
    switch (activeTab) {
      ...
      case "exam-and-organization":
        return <ExamAndOrganizationContent />;
      case "learn-with-edu":
        return <LearnWithEduContent />;
      default:
        return <SelfPracticeContent />;
    }
  };
        ...
        <div className="w-full flex bg-[#F0F2F5] min-h-[60vh] items-stretch">
          ...
          <div className="w-[35%] p-10 flex justify-end">
            <div className="w-[330px] flex flex-col gap-2">
              ...
              <a
                href="#"
                onClick={() => setActiveTab("exam-and-organization")}
                className={`${
                  activeTab === "exam-and-organization"
                    ? "text-blue-700 font-semibold"
                    : ""
                } hover:text-blue-700`}
              >
              ...
              <a
                href="#"
                onClick={() => setActiveTab("learn-with-edu")}
                className={`${
                  activeTab === "learn-with-edu"
                    ? "text-blue-700 font-semibold"
                    : ""
                } hover:text-blue-700`}
              >
